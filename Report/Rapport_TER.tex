...
\chapter{Organisation du projet}
    ...
    \section{Organisation du travail}
		...
		Avant de se mettre à  la réalisation, nous avons commencé par une étape d’initialisation d’ouvrage. Dans cette étape, nous avons tenu une réunion avec l’ensemble des parties prenantes  qui comprenaient les trois membres du groupe  mais également l’encadrant, et dans laquelle on a pu analyser  les besoins ainsi que clarifier les objectifs et les finalités du projet.
...
\section{Choix des outils de développement}
	...
	\subsection*{GIT}
	 Parmi ces outils, on a eu recours à un logiciel de gestion de versions. Les logiciels de ce type  permettent  de stocker un ensemble de fichiers  tout en conservant la chronologie de toutes les modifications qui ont été effectuées dessus.
...
\begin{figure}[h!]
	...
	\begin{tikzpicture}[node distance=1cm, auto]
		...
		\node[mynode] (accueil) {Page d'accueil};
		...
		\draw[myarrow] (accueil.south) -- ++(-.5,0) -- ++(0,-1) -|  (retailer1.north);
		\draw[myarrow] (accueil.south) -- ++(.5,0) -- ++(0,-1) -|  (retailer2.north);
		\end{tikzpicture}
