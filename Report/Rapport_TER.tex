...
\chapter{Développement}
  ...
  \section{Gestion de l'événementiel}
	...
	/*
		...
		- clientData: un éventuel objet contenant des données que l'on souhaite
	...
	*/
	...
	/*
		...
		- serverData: les éventuelles données envoyées par le serveur
...
\chapter{Manuel d'utilisation}
  ...
  Enfin, tous les contributeurs du projet (les artistes ayant collaboré avec nous ainsi que nous-mêmes) sont listés sur la page "crédits", également accessible à l'aide du lien ayant le même nom dans le menu.
